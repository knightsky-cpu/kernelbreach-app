...
MINISIGN_PUBLIC_KEY="${KERNELBREACH_MINISIGN_PUBLIC_KEY:-RWT6/CNZBepAmKX+60SGUAJ+f8oqfBbY9JHiGtuSoI4FNKRwPON6BBBz}"
...
require_command() {
  ...
  if [[ "$1" == "minisign" ]]; then
    fail "Missing minisign verifier. On Debian/Ubuntu, install it once with: sudo apt install minisign"
  fi
