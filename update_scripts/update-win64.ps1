...
$MinisignPublicKey = if ($env:KERNELBREACH_MINISIGN_PUBLIC_KEY) { $env:KERNELBREACH_MINISIGN_PUBLIC_KEY } else { "RWRg56ToZFyQ7H4pwaCMib4dBi8uLzBqpfLQcYg7hePzcSyJEjDNsIIU" }
